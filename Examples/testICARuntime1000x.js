...
var bytecode = "";
...
web3.eth.sendTransaction(createTx, function(err, hash)  {
  ...
  while (n < rep) {
    var d1 = new Date();
    var hash = instance.incrementCounterEmit(500,{from: "0x8461b6221f2e5d0376b8a567468370f60a19218a",gas: 700000});
    ...
    var d2 = new Date();
    // console.log('\n\t[FC' + (n+1) + '] Function incrementCounterEmit call tx: ' + hash);
    n++;
    var diff = d2.getTime() - d1.getTime();
    count += diff;
    console.log(diff);
  }
  console.log("Average: " + count/rep)
});
